...
Get the gist? If you want more fun with this, check out <tt>to_result</tt> with respect to Array, Symbol, Fixnum, and NilClass.
...
Options are:
  ...
  -s # choose either the "thin" or "mongrel" http server
